    ...
    <>
      <div className="sm:p-5 sm:flex gap-5 w-full relative">
        ...
        <div className="sm:p-20 p-1 w-full">
          ...
          /> : <div className="sm:min-w-[150px] sm:min-h-[150px] min-w-[100px] min-h-[100px] max-h-[100px] max-w-[100px] sm:max-h-[150px] sm:max-w-[150px] rounded-full sm:mt-[-10%] mt-[-17%] z-10 bg-[#1c1c24] border border-neutral-800"></div>}
      ...
      {openModal &&
        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70 ">
          <div className='relative w-full lg:w-3/6 my-6 mx-auto lg:max-w-3xl h-full lg:h-auto'>
            <div className='w-full lg:h-auto border-0 rounded-lg shadow-lg relative flex flex-col gap-6 h-auto p-5 bg-[#13131a] outline-none focus:outline-none'>
              <IoCloseOutline
