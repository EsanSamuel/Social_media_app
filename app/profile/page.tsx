    ...
    <>
      <div className="sm:p-5 sm:flex gap-5 w-full relative">
        ...
        <div className="sm:p-20 p-1 w-full">
          {!user.coverImage ? <div className='sm:min-h-[200px] min-h-[130px] bg-[#1c1c24] rounded'></div> :
            <Image
              src={user.coverImage}
              width={1000}
              height={1000}
              alt=""
              className='sm:min-h-[200px] min-h-[130px] rounded' />
          }
          <Image
            src={user.image}
            width={100}
      ...
      {openModal &&
        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800 bg-opacity-70 ">
          <div className='relative w-full lg:w-3/6 my-6 mx-auto lg:max-w-3xl h-full lg:h-auto'>
            <div className='w-full lg:h-auto border-0 rounded-lg shadow-lg relative flex flex-col gap-6 h-auto p-2 bg-[#13131a] outline-none focus:outline-none'>
              <IoCloseOutline
