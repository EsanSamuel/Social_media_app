...
const Users = () => {
  ...
  if (isLoading) {
    return (
      <div>
        <h1 className='text-[#eaeaea] mt-20 sm:flex hidden'></h1>
      </div>
    )
  }

  return (
    <div className=" border-l border-neutral-800 w-full  sticky top-5 min-h-[95vh] min-w-[200px] xl:block hidden overflow-y-auto">
